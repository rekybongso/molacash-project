...
const Footer = () => {
	return (
		<>
			<SubscribeSection />
			<div className='flex w-full flex-row justify-evenly bg-gray-300 pl-14 pr-14'>
				<div className='grid grid-flow-row gap-5 pb-7 pt-7 md:gap-3 lg:grid-flow-col lg:grid-cols-5'>
					<div id='faq-section'>
						<img
							className='w-32'
							src={logoMolacash}
						...
						<div className='flex flex-row gap-3'>
							...
							<p className='2xl:text-md 2 mt-3 text-sm'>
					...
					<div className='lg:w-fit 2xl:w-full'>
			...
			<div className='flex w-full flex-col items-center justify-center bg-gray-300'>
				...
				<p className='p-7 text-sm lg:mr-6 lg:self-end 2xl:mr-10'>
